...
class SBertConfigForWebshop(PretrainedConfig):
    model_type = "sbert"
...
class SBertModelForWebshop(PreTrainedModel):

    config_class = SBertConfigForWebshop
    ...
    def resize_token_embeddings(self, new_num_tokens):
        """Resize token embeddings to the specified size."""
